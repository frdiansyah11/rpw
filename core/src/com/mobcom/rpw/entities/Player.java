...
//    private static final int PLAYER_HEIGHT = 102;
    ...
    private static final int POWER_JUMP = 100;
    ...
    private void createBody(World world){
        ...
        body.setLinearVelocity(body.getLinearVelocity().x,-1000);
...
//        float force = body.getMass() * 10.0f / (1/60.0f);
        if (Gdx.input.isKeyJustPressed(Input.Keys.SPACE)){
              System.out.println("GO");
              body.setLinearVelocity(body.getLinearVelocity().x,0);
              body.setTransform(body.getPosition().x, body.getPosition().y + 120, 0);
              body.applyLinearImpulse(0, POWER_JUMP,body.getPosition().x, body.getPosition().y,true);
        }
    }
